...
public class UiOnOffServerActivity extends BaseModelConfigurationActivity implements ElementUiAdapter.UiOnOffCallback {
    ...
    public View getNodeControlsContainer() {
        return nodeControlsContainer;
    }

    View nodeControlsContainer = null;
    public void progressBar(){
        showProgressbar();
    }

   private ElementUiAdapter elementUiAdapter;

    @Override
    public final void addControlsUi(final MeshModel model) {
        if (model instanceof GenericOnOffServerModel) {
        final CardView cardView = findViewById(R.id.node_controls_card);
        nodeControlsContainer = LayoutInflater.from(this).inflate(R.layout.layout_ui_on_off, cardView);
